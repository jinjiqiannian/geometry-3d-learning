---
name: 工作日志
description: 自动生成工作日志，追加到docs/CHANGELOG.md
model: default
---
...
📝 中文说明
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🎯 核心作用：自动从git commits生成工作日志，追加到CHANGELOG.md
...
📌 关键要点：
   1. 自动获取变更范围 → 获取commit详情 → 分类整理 → 写入CHANGELOG
   2. 按模块分组（安全/架构/AI/前端/内容），不按commit顺序
   3. 每天一个条目，多条commit合并
   4. 突出量化结果（删了多少行、加了多少个模型、测试数）
   5. 模型库状态表放在每天末尾
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
-->
