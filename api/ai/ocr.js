...
9. 向量必须标出来：教材里字母上方的箭头一律写成 \overrightarrow{AB}
   （例如 \overrightarrow{AA'}、\overrightarrow{AB}）。
   漏掉箭头会把「向量点积」读成「线段长相乘」，含义完全不同，
   后面整道题都会错。箭头很细、字母很小、照片发虚时也要尽力辨认。
10. 同理，向量的模写成 |\overrightarrow{AB}|；共线、平行等符号照录。`
